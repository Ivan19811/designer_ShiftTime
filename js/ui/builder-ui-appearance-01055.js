// 01055 · Builder appearance controls + full auxiliary/sidebar styling.
import { createBuilderUiPreferences01055 } from './builder-ui-preferences-01055.js?v=01055';

const STAGE = '01055';
const preferences = createBuilderUiPreferences01055();
...
function hasMainStyleOverrides01055(a){
  if(!a)return false;
...
function hasAdditionalStyleOverrides01055(a){
  if(!a)return false;
...
function hasSideStyleOverrides01055(a){
  if(!a)return false;
...
function applyAppearance01054(state=preferences.get()){
  ...
  if(!root)return;
  const a=state.appearance||{};
  root.dataset.stUiCustom=hasMainStyleOverrides01055(a)?'1':'0';
  root.dataset.stUiAdditionalCustom=hasAdditionalStyleOverrides01055(a)?'1':'0';
  root.dataset.stUiSideCustom=hasSideStyleOverrides01055(a)?'1':'0';
...
export function initBuilderUiAppearance01055(){
  applyInspector01054();
  applyAppearance01054();
  installButtonBindings01054();
  try{window.ST_BUILDER_UI_APPEARANCE_01055=Object.freeze({stage:STAGE,preferences,open:openAppearanceWindow01054,apply:()=>{applyInspector01054();applyAppearance01054();}});}catch{}
}
