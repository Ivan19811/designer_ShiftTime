...
function contextHtml(){return `<aside class="mp-context"><div class="mp-context__block" data-mp-system-status-block><div class="mp-context__eyebrow">Marketplace</div><div class="mp-context__title">Стан системи</div><div class="mp-context__metric" data-mp-system-metric="stage"><span>Studio stage</span><b>${MP_STAGE}</b></div><div class="mp-context__metric" data-mp-system-metric="repository"><span>Repository</span><b>pending</b></div><div class="mp-context__metric" data-mp-system-metric="product-editor"><span>Product Editor</span><b>Підготовлено</b></div><div class="mp-context__metric" data-mp-system-metric="category-editor"><span>Category Editor</span><b>Підготовлено</b></div><div class="mp-context__metric" data-mp-system-metric="revision"><span>Revision</span><b>0</b></div></div><div class="mp-context__block"><div class="mp-context__eyebrow">Architecture</div><div class="mp-context__title">Джерела правди</div><div class="mp-context__notice"><b>SiteFrameStore</b><br>Тільки дизайн сайту.<br><br><b>MarketplaceStore</b><br>Товари, категорії, attributes, variants, feeds, SEO.</div></div><div class="mp-context__block"><div class="mp-context__eyebrow">Безпека етапу</div><div class="mp-context__title">Stub mode</div><div class="mp-context__notice is-warn">Кнопки CRUD/імпорту/експорту зараз не змінюють дані. Вони позначають майбутні точки підключення API.</div></div></aside>`;}
