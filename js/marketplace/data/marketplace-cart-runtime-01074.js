...
function desired(){const c=getMarketplaceBackendConfig01071(),s=getMarketplaceBackendStatus01071();return c.mode==='api'&&s.state==='api'?new ApiMarketplaceCartRepository01074({baseUrl:c.apiBaseUrl,requestTimeoutMs:c.requestTimeoutMs}):new LocalMarketplaceCartRepository01074();}
