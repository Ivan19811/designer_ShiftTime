// js/design/widgets/site-footer/footer-insert-widget.js

import { openGalleryModal } from '../gallery-widget/gallery-widget.js';
// Заглушка-інспектор для вставки СТАНДАРТНИХ блоків у ШАПКУ.
//
// Важливо:
// - Нічого не вставляє і не змінює DOM футера (поки що).
// - Лише показує UI з 8 базовими типами блоків.
// - Відкривається з Footer Builder Mode по події: window.dispatchEvent(new CustomEvent('st:footer-insert:open'))

const SEC_ATTR = 'data-st-footer-insert';
const SEC_ID = 'st-footer-insert-section';

const ICON_PICK_KEY = 'st_footer_insert_icon_pick_v1';
const PHONE_ICON_POS_KEY = 'st_footer_insert_phone_icon_pos_v1';
const LOGO_MODE_KEY = 'st_footer_insert_logo_mode_v1';
const LOGO_SOURCE_KEY = 'st_footer_insert_logo_source_v1';
const LOGO_POS_KEY = 'st_footer_insert_logo_pos_v1';
const LOGO_IMAGE_PICK_KEY = 'st_footer_insert_logo_image_pick_v1';
const LOGO_MARK_WIDTH_KEY = 'st_footer_insert_logo_mark_width_v1';
const LOGO_MARK_HEIGHT_KEY = 'st_footer_insert_logo_mark_height_v1';
const LOGO_GAP_KEY = 'st_footer_insert_logo_gap_v1';
const LOGO_FIT_KEY = 'st_footer_insert_logo_fit_v1';
const LOGO_ALIGN_KEY = 'st_footer_insert_logo_align_v1';
const LOGO_TEXT_TARGET_KEY = 'st_footer_insert_logo_text_target_v1';
const LOGO_TITLE_SIZE_KEY = 'st_footer_insert_logo_title_size_v1';
const LOGO_SUBTITLE_SIZE_KEY = 'st_footer_insert_logo_subtitle_size_v1';
const LOGO_TITLE_OFFSET_X_KEY = 'st_footer_insert_logo_title_offset_x_v1';
const LOGO_TITLE_OFFSET_Y_KEY = 'st_footer_insert_logo_title_offset_y_v1';
const LOGO_SUBTITLE_OFFSET_X_KEY = 'st_footer_insert_logo_subtitle_offset_x_v1';
const LOGO_SUBTITLE_OFFSET_Y_KEY = 'st_footer_insert_logo_subtitle_offset_y_v1';
const LOGO_LINK_MODE_KEY = 'st_footer_insert_logo_link_mode_v1';
const LOGO_LINK_URL_KEY = 'st_footer_insert_logo_link_url_v1';
const LOGO_LINK_NEWTAB_KEY = 'st_footer_insert_logo_link_newtab_v1';
const LOGO_CLICK_AREA_KEY = 'st_footer_insert_logo_click_area_v1';
const LOGO_MOBILE_MODE_KEY = 'st_footer_insert_logo_mobile_mode_v1';
const LOGO_MOBILE_MARK_WIDTH_KEY = 'st_footer_insert_logo_mobile_mark_width_v1';
const LOGO_MOBILE_TITLE_SIZE_KEY = 'st_footer_insert_logo_mobile_title_size_v1';
const LOGO_MOBILE_SUBTITLE_SIZE_KEY = 'st_footer_insert_logo_mobile_subtitle_size_v1';
const LOGO_MOBILE_GAP_KEY = 'st_footer_insert_logo_mobile_gap_v1';
const LOGO_HOVER_TARGET_KEY = 'st_footer_insert_logo_hover_target_v1';
const LOGO_HOVER_METRIC_PREFIX = 'st_footer_insert_logo_hover_metric_v1';
const PNG_IMAGE_PICK_KEY = 'st_footer_insert_png_image_pick_v1';
const PNG_LINK_MODE_KEY = 'st_footer_insert_png_link_mode_v1';
const PNG_LINK_URL_KEY = 'st_footer_insert_png_link_url_v1';
const PNG_LINK_NEWTAB_KEY = 'st_footer_insert_png_link_newtab_v1';
const PNG_CLICK_AREA_KEY = 'st_footer_insert_png_click_area_v1';
const PNG_MOBILE_MODE_KEY = 'st_footer_insert_png_mobile_mode_v1';
const PNG_MOBILE_WIDTH_KEY = 'st_footer_insert_png_mobile_width_v1';
const PNG_MOBILE_HEIGHT_KEY = 'st_footer_insert_png_mobile_height_v1';
const PNG_MOBILE_IMAGE_PICK_KEY = 'st_footer_insert_png_mobile_image_pick_v1';
const PNG_HOVER_TARGET_KEY = 'st_footer_insert_png_hover_target_v1';
const PNG_HOVER_METRIC_PREFIX = 'st_footer_insert_png_hover_metric_v1';
const PNG_EXTRA_PRESET_KEY = 'st_footer_insert_png_extra_preset_v1';
const PNG_GLOW_TARGET_KEY = 'st_footer_insert_png_glow_target_v1';
const PNG_GLOW_COLOR_KEY = 'st_footer_insert_png_glow_color_v1';
const PNG_GLOW_OPACITY_KEY = 'st_footer_insert_png_glow_opacity_v1';
const PNG_GLOW_BLUR_KEY = 'st_footer_insert_png_glow_blur_v1';
const PNG_GLOW_SPREAD_KEY = 'st_footer_insert_png_glow_spread_v1';
const BUTTON_TEXT_KEY = 'st_footer_insert_button_text_v1';
const BUTTON_MODE_KEY = 'st_footer_insert_button_mode_v1';
const BUTTON_ICON_POS_KEY = 'st_footer_insert_button_icon_pos_v1';
const BUTTON_ICON_PICK_KEY = 'st_footer_insert_button_icon_pick_v1';
const BUTTON_LINK_MODE_KEY = 'st_footer_insert_button_link_mode_v1';
const BUTTON_LINK_URL_KEY = 'st_footer_insert_button_link_url_v1';
const BUTTON_LINK_NEWTAB_KEY = 'st_footer_insert_button_link_newtab_v1';
const BUTTON_CLICK_AREA_KEY = 'st_footer_insert_button_click_area_v1';
const BUTTON_MOBILE_MODE_KEY = 'st_footer_insert_button_mobile_mode_v1';
const BUTTON_MOBILE_LABEL_KEY = 'st_footer_insert_button_mobile_label_v1';
const BUTTON_MOBILE_WIDTH_KEY = 'st_footer_insert_button_mobile_width_v1';
const BUTTON_MOBILE_LABEL_SIZE_KEY = 'st_footer_insert_button_mobile_label_size_v1';
const BUTTON_MOBILE_ICON_SIZE_KEY = 'st_footer_insert_button_mobile_icon_size_v1';
const BUTTON_MOBILE_GAP_KEY = 'st_footer_insert_button_mobile_gap_v1';
const BUTTON_HOVER_TARGET_KEY = 'st_footer_insert_button_hover_target_v1';
const BUTTON_HOVER_METRIC_PREFIX = 'st_footer_insert_button_hover_metric_v1';
const BUTTON_EXTRA_PRESET_KEY = 'st_footer_insert_button_extra_preset_v1';
const BUTTON_SHAPE_KEY = 'st_footer_insert_button_shape_v1';
const BUTTON_FILL_MODE_KEY = 'st_footer_insert_button_fill_mode_v1';
const BUTTON_COLOR1_KEY = 'st_footer_insert_button_color1_v1';
const BUTTON_COLOR2_KEY = 'st_footer_insert_button_color2_v1';
const BUTTON_GRADIENT_ANGLE_KEY = 'st_footer_insert_button_gradient_angle_v1';
...
<div class="st-hb-subacc__row" style="display:flex;gap:8px;flex-wrap:wrap;margin-top:8px;">
  ...
  <button type="button" class="st-hb-insbtn" data-st-hb-button-extra-preset="cta">Footer CTA</button>
</div>
<div class="st-hb-subacc__row" style="display:flex;gap:8px;flex-wrap:wrap;margin-top:8px;">
    ...
    await openGalleryModal({
      ...
      onPick: async (payload) => {
        ...
        try {
          ...
          try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:image:apply', { detail: picked })); } catch (e) {}
          if (onPicked) {
    ...
    await openGalleryModal({
      ...
      onPick: async (payload) => {
        ...
        try {
          ...
          try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:image:apply', { detail: picked })); } catch (e) {}
          if (onPicked) {
            try { onPicked(picked); } catch(e) {}
          }
        } catch(e) {}
...
function applyPngHoverInputChange_(sectionEl, metric, value){
  ...
  try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:hover:apply', { detail: collectPngHoverDetail_() })); } catch (e) {}
}
...
function applyPngExtrasInputChange_(sectionEl, metric, value){
  ...
  try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:extras:apply', { detail: collectPngExtrasDetail_() })); } catch (e) {}
}
    ...
    await openGalleryModal({
      ...
      onPick: async (payload) => {
        ...
        try {
          ...
          try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:icon:apply', { detail: getPickedButtonIconPayload_() })); } catch(e) {}
        } catch(e) {}
      }
    });
  } catch(e) {}
...
function applyButtonHoverInputChange_(sectionEl, metric, value){
  ...
  syncButtonHoverUi_(sectionEl);
  try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:hover:apply', { detail: collectButtonHoverDetail_() })); } catch (e) {}
}
...
function applyButtonExtrasInputChange_(sectionEl){
  syncButtonExtrasUi_(sectionEl);
  renderButtonPreview_(sectionEl);
  try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:extras:apply', { detail: collectButtonExtrasDetail_() })); } catch (e) {}
}
...
function applyLogoHoverInputChange_(sectionEl, metric, value){
  ...
  try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:hover:apply', { detail: collectLogoHoverDetail_() })); } catch (e) {}
}
...
function applyLogoPreset_(sectionEl, preset){
  ...
  renderLogoPreview_(sectionEl);
  try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:layout:apply', { detail: collectLogoLayoutDetail_() })); } catch (e) {}
}
...
function initFooterInsertWidget(host) {
  if (!host) return;
  ...
  sectionEl.innerHTML = `
    <button class="design-section__header" type="button">
      <div class="design-section__header-title"><span>Футер</span></div>
      <span class="design-section__chevron">▶</span>
    </button>
    <div class="design-section__body" hidden>
      <div class="st-hb-insert-intro">
        Вибери стандартний блок для вставки в футер. (Поки що — <b>заглушки</b> UI)
      </div>
      <div class="st-hb-insert-list" data-st-hb-insert-list></div>
    </div>

    <style>
      /* секція "Footer Insert" існує завжди, але показується тільки в режимі вставки */
      #${SEC_ID}{ display:none; }
      body.st-footer-builder-on.st-hb-insert-on #${SEC_ID}{ display:block; }

      /* у режимі вставки ховаємо всі інші секції дизайну */
      body.st-footer-builder-on.st-hb-insert-on #design-panel .design-section:not(#${SEC_ID}){ display:none !important; }
  ...
  // вставляємо на початок — щоб "Футер" була першою
  ...
  if (list) {
    const items = [
      { t: 'Текст',     d: 'Звичайний текстовий елемент (inline). Безпечний для футера.' },
      { t: 'Заголовок', d: 'Заголовок (H1–H6). Для футера зазвичай H3–H6.' },
      { t: 'Лого',      d: 'Логотип (SVG/PNG) з керуванням розмірами та відступами.' },
      { t: 'PNG',       d: 'Картинка з прозорим фоном (PNG/WebP) — як елемент у футері.' },
      ...
      { t: 'Кнопка',    d: 'CTA-кнопка (посилання/дія). Стандартний елемент футера.' },
...
<div class="st-hb-subacc__hint">
  Спочатку натисни <b>Додати текст</b> (елемент зʼявиться в футері). Потім — <b>Налаштувати</b>.
</div>`
        }));
...
<div class="st-hb-subacc__hint">
  Спочатку натисни <b>Додати заголовок</b> (елемент зʼявиться у вибраному контейнері футера).
...
<div class="st-hb-subacc__hint">
  ...
  <br>Після вставки — клікни по іконці в футері і натисни <b>Налаштувати іконку</b>.
</div>`
        }));
      } else if (it.t === 'Меню') {
        list.appendChild(makeSubAccordion(it.t, it.d, {
...
<div class="st-hb-subacc__hint">
  1) Спочатку <b>клікни по контейнеру</b> у футері/футері → 2) натисни <b>Big</b> або <b>Burger</b>.
...
<div class="st-hb-subacc__hint">
  ...
  sectionEl.addEventListener('click', (ev) => {
    ...
    if (addBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:text:add')); } catch (e) {}
      return;
    }
    ...
    if (tuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:text:tune')); } catch (e) {}
    ...
    if (headingAddBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:heading:add')); } catch (e) {}
      return;
    }
    ...
    if (headingTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:heading:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-text-widget')); } catch (e) {}
      return;
    }
    ...
    if (productSearchAddBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:product-search:add', { detail: collectProductSearchDetail_(sectionEl) })); } catch (e) {}
      return;
    }
    ...
    if (productSearchTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:product-search:tune')); } catch (e) {}
    ...
    if (buttonAddBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:add', { detail: collectButtonDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (buttonTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:tune')); } catch (e) {}
      return;
    }
    ...
    if (buttonTextTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:text:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-text-widget')); } catch (e) {}
      return;
    }
    ...
    if (buttonIconTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:icon:tune')); } catch (e) {}
    ...
    if (buttonModeBtn) {
      ...
      renderButtonPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:mode:apply', { detail: { mode } })); } catch (e) {}
      return;
    }
    ...
    if (buttonPosBtn) {
      ...
      renderButtonPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:icon-pos:apply', { detail: { iconPosition: pos } })); } catch (e) {}
      return;
    }
    ...
    if (buttonLinkModeBtn) {
      ...
      syncButtonBehaviorUI_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:link:apply', { detail: collectButtonLinkDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (buttonMobileModeBtn) {
      ...
      syncButtonAdaptiveUi_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:adaptive:apply', { detail: collectButtonAdaptiveDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (logoModeBtn) {
      ...
      renderLogoPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:mode:apply', { detail: { mode } })); } catch (e) {}
      return;
    }
    ...
    if (logoSourceBtn) {
      ...
      renderLogoPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:source:apply', { detail: { source } })); } catch (e) {}
      return;
    }
    ...
    if (logoPosBtn) {
      ...
      renderLogoPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:pos:apply', { detail: { position: pos } })); } catch (e) {}
      return;
    }
    ...
    if (logoImageChooseBtn) {
      ...
      renderLogoPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:source:apply', { detail: { source: 'image' } })); } catch (e) {}
    ...
    if (logoIconChooseBtn) {
      ...
      renderLogoPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:source:apply', { detail: { source: 'icon' } })); } catch (e) {}
      pickIconViaGallery_(sectionEl, {
        onPicked: (payload) => {
          renderLogoPreview_(sectionEl);
          try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:icon:apply', { detail: payload })); } catch (e) {}
        }
      }).catch(() => {});
      return;
    }
    ...
    if (logoAddBtn) {
      ...
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:add', { detail })); } catch (e) {}
      return;
    }
    ...
    if (logoTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:tune')); } catch (e) {}
      return;
    }
    ...
    if (logoTextTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:text:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-text-widget')); } catch (e) {}
      return;
    }
    ...
    if (logoSubtitleTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:subtitle:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-text-widget')); } catch (e) {}
      return;
    }
    ...
    if (logoSignTuneBtn) {
      ...
      if (loadLogoSource_() === 'image') {
        ...
        try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:sign:tune')); } catch (e) {}
        try { window.dispatchEvent(new CustomEvent('st:design:focus-icon-widget')); } catch (e) {}
      }
      return;
    }
    ...
    if (logoLinkModeBtn) {
      ...
      syncLogoLinkUi_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:link:apply', { detail: collectLogoLinkDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (logoMobileModeBtn) {
      ...
      syncLogoAdaptiveUi_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:logo:adaptive:apply', { detail: collectLogoAdaptiveDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (pngAddBtn) {
      ...
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:add', { detail })); } catch (e) {}
      return;
    }
    ...
    if (pngTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:tune')); } catch (e) {}
      return;
    }
    ...
    if (pngLinkModeBtn) {
      ...
      syncPngLinkUi_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:link:apply', { detail: collectPngLinkDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (pngMobileModeBtn) {
      ...
      syncPngAdaptiveUi_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:png:adaptive:apply', { detail: collectPngAdaptiveDetail_() })); } catch (e) {}
      return;
    }
    ...
    if (phoneAddBtn) {
      ...
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:phone:add', { detail: { icon: payload, position } })); } catch (e) {}
      return;
    }
    ...
    if (phoneTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:phone:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-text-widget')); } catch (e) {}
      return;
    }
    ...
    if (phoneIconTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:phone:icon:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-icon-widget')); } catch (e) {}
      return;
    }
    ...
    if (iconAddBtn) {
      ...
      const payload = getPickedIconPayload_();
      if (!payload) return;
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:icon:add', { detail: payload })); } catch(e) {}
      return;
    }
    ...
    if (iconTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:icon:tune')); } catch (e) {}
      try { window.dispatchEvent(new CustomEvent('st:design:focus-icon-widget')); } catch (e) {}
      return;
    }
    ...
    if (menuBigBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:menu:add', { detail: { variant: 'big' } })); } catch(e) {}
      return;
    }
    ...
    if (menuBurgerBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:menu:add', { detail: { variant: 'burger' } })); } catch(e) {}
      return;
    }
    ...
    if (menuTuneBtn) {
      ev.preventDefault();
      ev.stopPropagation();
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:menu:tune')); } catch(e) {}
  ...
  sectionEl.addEventListener('input', (ev) => {
    ...
    if (t && t.matches && t.matches('[data-st-hb-button-text]')) {
      ...
      syncButtonInputs_(sectionEl);
      renderButtonPreview_(sectionEl);
      try { window.dispatchEvent(new CustomEvent('st:footer-insert:button:text:apply', { detail: { text: loadButtonText_() } })); } catch (e) {}
      return;
    }
  ...
  const footerBtn = sectionEl.querySelector('.design-section__header');
  if (footerBtn && !footerBtn.__st_bound) {
    footerBtn.__st_bound = true;
  ...
  // Події відкриття/закриття з Footer Builder
  if (!window.__ST_HB_INSERT_WIDGET_BINDED__) {
    window.__ST_HB_INSERT_WIDGET_BINDED__ = true;

    window.addEventListener('st:footer-insert:open', () => {
      try {
    ...
    window.addEventListener('st:footer-insert:close', () => {
      try {
        ensureOpen(document.getElementById(SEC_ID), false);
      } catch (e) {}
    });

    // Фокус "тільки Текст" у режимі дизайну (для футера)
    window.addEventListener('st:design:focus-text-widget', () => {
      try {
        if (!document.body.classList.contains('st-footer-builder-on')) return;
    ...
    // Фокус "тільки Меню" у режимі дизайну (для футера)
    ...
    // Фокус "тільки Іконка" у режимі дизайну (для футера)
  ...
  if (document.body.classList.contains('st-footer-builder-on') && document.body.classList.contains('st-hb-insert-on')) {
    ensureOpen(sectionEl, true);
  }
}

export { initFooterInsertWidget };