// js/design/widgets/page-tree/page-tree-widget-01020.js
// Віджет "Дерево сторінки" для панелі "Дизайн" (правий сайтбар).

import { initPageTreePanel } from '../../../panel-page-tree-01020.js?v=01020';
...
export function initPageTreeWidget(host, getSelection) {
    ...
    <button class="design-section__header" type="button" data-page-tree-help-anchor>
      ...
      <div class="design-page-tree__help-popover" role="tooltip">
        ...
        <div class="design-page-tree__help-text">
          <b>Один клік у Дереві</b> виділяє цей елемент і підсвічує його на сайті.
          <b>Один клік на сайті</b> робить зворотне: Дерево саме відкриває потрібну гілку, підсвічує елемент і прокручує його у видиму область.
          <br><br>
          ...
          <br><br>
          Якщо зверху ввімкнути, наприклад, <b>Контейнери</b>, усі контейнери підсвітяться одночасно і на сайті, і в Дереві. Те саме працює для інших типів.
          <br><br>
  ...
  initPageTreePanel();
  initPageTreeWheelScroll01020_(sectionEl);
}
...
function initPageTreeWheelScroll01020_(sectionEl) {
  const wrap = sectionEl?.querySelector?.('#page-tree-wrap');
  if (!wrap || wrap.dataset.stTreeWheel01020 === '1') return;
  wrap.dataset.stTreeWheel01020 = '1';
