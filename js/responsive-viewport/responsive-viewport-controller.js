// 00958-RESPONSIVE-VIEWPORT-CONTROLS
// One builder-only authority for viewport simulation state. It does not write
// SiteFrame JSON, history, template data, or generated site markup.
...
export const RESPONSIVE_VIEWPORT_PRESETS_00958 = Object.freeze([
  { id: 'qhd-2560', group: 'desktop', label: 'QHD Desktop', width: 2560, height: 1440 },
  { id: 'fhd-1920', group: 'desktop', label: 'Full HD Desktop', width: 1920, height: 1080 },
  { id: 'desktop-1680', group: 'desktop', label: 'Desktop 16:10', width: 1680, height: 1050 },
  { id: 'desktop-1600', group: 'desktop', label: 'Desktop HD+', width: 1600, height: 900 },
  { id: 'laptop-1536', group: 'laptop', label: 'Laptop HiDPI', width: 1536, height: 864 },
  { id: 'laptop-1440', group: 'laptop', label: 'Laptop 16:10', width: 1440, height: 900 },
  { id: 'laptop-1366', group: 'laptop', label: 'Laptop HD', width: 1366, height: 768 },
  { id: 'laptop-1280', group: 'laptop', label: 'Laptop Compact', width: 1280, height: 800 },
  { id: 'tablet-1024', group: 'tablet', label: 'Tablet Landscape', width: 1024, height: 768 },
  { id: 'tablet-834', group: 'tablet', label: 'Tablet Pro Portrait', width: 834, height: 1194 },
  { id: 'tablet-820', group: 'tablet', label: 'Tablet Large Portrait', width: 820, height: 1180 },
  { id: 'tablet-768', group: 'tablet', label: 'Tablet Portrait', width: 768, height: 1024 },
  { id: 'phone-430', group: 'phone', label: 'Phone Large', width: 430, height: 932 },
  { id: 'phone-414', group: 'phone', label: 'Phone Plus', width: 414, height: 896 },
  { id: 'phone-390', group: 'phone', label: 'Phone Modern', width: 390, height: 844 },
  { id: 'phone-375', group: 'phone', label: 'Phone Standard', width: 375, height: 812 },
  { id: 'phone-360', group: 'small-phone', label: 'Phone Small', width: 360, height: 800 },
  { id: 'phone-320', group: 'small-phone', label: 'Phone Extra Small', width: 320, height: 568 }
]);
    ...
    <section class="st-rvp" aria-label="Керування адаптивністю сайту">
      ...
      <div class="st-rvp__panel" id="st-rvp-panel" role="dialog" aria-modal="false" aria-labelledby="st-rvp-panel-title" hidden>
        <div class="st-rvp__panel-head">
          <div><h2 class="st-rvp__panel-title" id="st-rvp-panel-title">Налаштування адаптивності</h2><p class="st-rvp__panel-subtitle">Точні розміри полотна сайту для перевірки макета. Розміри наведено від найбільшого до найменшого.</p></div>
          <button class="st-rvp__panel-close" type="button" data-rvp-close aria-label="Закрити">×</button>
        </div>
        <div class="st-rvp__status-row">
          <div class="st-rvp__status">Поточний режим<strong data-rvp-panel-status>Вимкнено · повна ширина</strong></div>
        ...
        <section class="st-rvp__section" aria-labelledby="st-rvp-manual-title">
          ...
          <p class="st-rvp__section-note">Введіть ширину й висоту або коригуйте їх точними кроками. Боковий блакитний маркер на полотні змінює ширину мишкою.</p>
        ...
        <section class="st-rvp__section" aria-labelledby="st-rvp-standards-title">
          ...
          <p class="st-rvp__section-note">Прапорець додає розмір у швидкий список сайдбара. «Відкрити» одразу застосовує його.</p>
      ...
      <aside class="st-rvp__help" id="st-rvp-help" role="tooltip" hidden>
        ...
        <p>Оберіть тип екрана внизу сайдбара — сайт відкриється у точному тестовому розмірі.</p>
        <ol><li>Екран, ноутбук, планшет і телефони застосовують стандартні пресети.</li><li>Ручний режим: тягніть блакитний маркер праворуч від полотна.</li><li>Шестерня відкриває всі розміри та точні кроки.</li><li>«Вимкнути адаптивність» повертає звичайну повну ширину.</li></ol>
      </aside>
    </section>`;
}
...
export function initResponsiveViewportController00958() {
  ...
  function announceChange00958_() {
    window.dispatchEvent(new CustomEvent('st:responsive-viewport-change', { detail: { ...state } }));
  }
  ...
  window.ST_RESPONSIVE_VIEWPORT_00958 = Object.freeze({
    getState: () => ({ ...state, favorites: [...state.favorites] }),
    applyPreset: applyPreset00958_,
    disable: () => commitState00958_({ enabled: false })
  });
  return window.ST_RESPONSIVE_VIEWPORT_00958;
}
