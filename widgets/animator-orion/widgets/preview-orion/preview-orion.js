...
updateObject(obj);
  ...
  if (footerRightEl){
    footerRightEl.appendChild(btnGrid);
    footerRightEl.appendChild(btnToggle);
    footerRightEl.appendChild(btnText);
    footerRightEl.appendChild(btnLay);
    footerRightEl.appendChild(btnDemo);
  }
